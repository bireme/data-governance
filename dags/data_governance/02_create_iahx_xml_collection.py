...
def transform_and_migrate():
    ...
    for doc in source_col.find(query):
        ...
        transformed = {
            ...
            'related_resource': doc.get('related_resource')[0] if isinstance(doc.get('related_resource'), list) and len(doc.get('related_resource')) == 1 else str(doc.get('related_resource')) if doc.get('related_resource') else None,
