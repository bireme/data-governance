...
def create_metric_dimentions_region():
    logger = logging.getLogger(__name__)
...
with DAG(
    'TMGL_REGION_02_create_metric_dimentions',
    ...
    create_metric_dimentions_region_task = PythonOperator(
        task_id='create_metric_dimentions_region',
        python_callable=create_metric_dimentions_region
    )
