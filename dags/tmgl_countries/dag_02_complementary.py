...
def create_metric_complementary(country):
...
with DAG(
    'TMGL_COUNTRIES_02_create_metric_complementary',
    description='TMGL COUNTRIES - Calcula o total de documentos por complementary medicine e ano',
    ...
    create_metric_complementary_task = PythonOperator.partial(
    ...
    get_eligible_countries_task >> create_metric_complementary_task