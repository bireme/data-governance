...
def create_metric_regions(country):
    ...
    for result in source_collection.aggregate(pipeline):
        ...
        logger.info(f"{country}, {region_name}, {year}")
...
with DAG(
    'TMGL_COUNTRIES_02_create_metric_regions',
    description='TMGL COUNTRIES - Calcula o total de documentos por região e ano',
