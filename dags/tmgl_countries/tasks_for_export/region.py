...
def generate_html_region(year_from, country, country_iso):
    ...
    documents = list(collection.find({"type": "region", "country": country}).sort("year", 1))
    aggregated_data = []
    ...
    output_file = os.path.join(output_dir, f"{country_iso}_region_year.json")
